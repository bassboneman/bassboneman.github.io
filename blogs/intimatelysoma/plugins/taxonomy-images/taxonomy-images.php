...
function taxonomy_image_plugin_url( $file = '' ) {
	static $path = '';
	if ( empty( $path ) ) {
		$path = get_template_directory_uri() . '/plugins/taxonomy-images/';
	}
	return $path . $file;
}
...
function taxonomy_image_plugin_text_domain() {
	load_plugin_textdomain( 'taxonomy-images', false,  get_template_directory() . '/plugins/taxonomy-images/languages/' );
}
