 ...
 * @since     0.7
 */
function taxonomy_images_plugin_get_queried_term_image_id( $taxonomy_term_obj ) {
	$filter = 'taxonomy-images-queried-term-image-id';
	if ( $filter !== current_filter() ) {
		taxonomy_image_plugin_please_use_filter( __FUNCTION__, $filter );
	}

	$obj = empty( $taxonomy_term_obj ) ? get_queried_object() : $taxonomy_term_obj;
 ...
 * @since     0.7
 */
function taxonomy_images_plugin_get_queried_term_image_url( $default = array(), $args = array() ) {
	...
	$data = apply_filters( 'taxonomy-images-queried-term-image-data', $default, $args );
 ...
 * @alter     0.7.2
 */
function taxonomy_images_plugin_get_queried_term_image_data( $default = 0, $args = array() ) {
	...
	$ID = apply_filters( 'taxonomy-images-queried-term-image-id', $default );
