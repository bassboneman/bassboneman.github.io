...
class Shortcode_UI_Field_Post_Select {
	...
	public function action_enqueue_shortcode_ui() {
		...
		wp_enqueue_script(
			...
			get_template_directory_uri() . '/plugins/tweaked-shortcode-ui/js/build/field-post-select.js',
			array( 'shortcode-ui', 'select2' )
		);

		wp_enqueue_script( 'select2', get_template_directory_uri() . '/plugins/tweaked-shortcode-ui/lib/select2/select2.min.js' , array( 'jquery', 'jquery-ui-sortable' ), '3.5.2' );
		wp_enqueue_style( 'select2', get_template_directory_uri() . '/plugins/tweaked-shortcode-ui/lib/select2/select2.css', null, '3.5.2' );
